...
namespace modularexpress.Controllers
{
    ...
    {
        public readonly ISignup signup = null;
        ...
        {
            ISignup selecteddatagroup = new Signup();
            ...
            {               
                ...
                string Checkemail()
                {
                    ...
                    else
                    {
                        ...
                        command.CommandText = "Execute login_stored @LoginId, @FirstName, @LastName, @Role, @Email, @Password, @Confirm_Password, @Confirmed, @Autocode";

                        SqlCommand command2 = new SqlCommand("select top 1 LoginId, Autocode from login order by LoginId DESC", connection);
                        ...
                        if (dataReader.HasRows == true)
                        {
                            while (dataReader.Read())
                            {
                                ...
                                b = Convert.ToInt64(a);
                                auto = Convert.ToInt32(selecteddatagroup.Autocode);

                                var generator = new RandomGenerator();
                                var randomNumber = generator.RandomNumber(Convert.ToInt32(auto), 9999999);
                                ...
                                long autogeneratedcode = randomNumber;
                                command.Parameters.Add("@Autocode", SqlDbType.BigInt).Value = autogeneratedcode;
                            }
                        ...
                        else
                        {
                            ...
                            command.Parameters.Add("@Autocode", SqlDbType.BigInt).Value = 1213151;
