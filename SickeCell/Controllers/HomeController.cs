...
namespace SickeCell.Controllers
{
    ...
    {
        // To apply the Interface in the Controller
        private readonly ISickleCelloverviewclass iSickleCelloverviewclass;
        ...
        [HttpPost]
        //public ActionResult PatientView(ISickleCelloverviewclass patientdataview)
        public ActionResult PatientView(SickleCelloverviewclass patientdataview)
        {                      
            List<ISickleCelloverviewclass> overviewdata = new List<ISickleCelloverviewclass>();
            try
            {                
                if (patientdataview.FirstName == null)
                {
                    ...
                    if (overviewreader.HasRows == true)
                    {
                        ...
                        {
                            // To apply the Dependency Inversion ( IoC ) principles                             
                            ISickleCelloverviewclass overviewddatagroup = Factory.CreateSickleCelloverviewclass();
                    ...
                    if (overviewreader2.HasRows == true)
                    {
                        while (overviewreader2.Read())
                        {
                            ...
                            // To apply the Dependency Inversion ( IoC ) principles
                            ISickleCelloverviewclass overviewddatagroup2 = Factory.CreateSickleCelloverviewclass();
