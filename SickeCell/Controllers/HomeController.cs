...
namespace SickeCell.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Breakdown(SickleCelloverviewclass breakdownfilter)
        {
            ...
            List<ISickleCelloverviewclass> breakdownview = new List<ISickleCelloverviewclass>();
            ...
            try
            {
                ...
                if (breakdownreader.HasRows == true)
                {
                    while (breakdownreader.Read())
                    {
                        ...
                        ISickleCelloverviewclass breakdowndatagroup = Factory.CreateSickleCelloverviewclass();
