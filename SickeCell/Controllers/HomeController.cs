...
namespace SickeCell.Controllers
{
    ...
    {        
        ...
        public ActionResult MobileLogin2()
        {
            ViewBag.Title = "Login Page - SickleCell";
        ...
        public ActionResult MobileSignup()
        {
            ViewBag.Title = "Signup Page - SickleCell";
        ...
        public ActionResult MobileSuccessful()
        {
            ViewBag.Title = "Successfull Page - SickleCell";
        ...
        public ActionResult MobileCasenotes()
        {
            ViewBag.Title = "This is a Casenotes Page - SickleCell";
        ...
        public ActionResult MobilePatientOverview()
        {
            ViewBag.Title = "This is a Patient Overview Page - SickleCell";
        ...
        public ActionResult MobileUploadcsv()
        {
            ViewBag.Title = "This is for Upload CSV Page - SickleCell";
        ...
        {
            ViewBag.Title = "This is for Patient Page - SickleCell";
        ...
        public ActionResult MobileManageconsole()
        {
            ViewBag.Title = "This is for a Management Console";
        ...
        public ActionResult MobileManageconsoleoption()
        {
            ViewBag.Title = "This is for a Console Option";
        ...
        public ActionResult MobileConsolesignup()
        {
            ViewBag.Title = "This is for a Super Admin and Admin Signup";
        ...
        public ActionResult MobileForgotPassword()
        {
            ViewBag.Title = "ForgotPassword";
        ...
        public ActionResult MobileVerificationcode()
        {
            ViewBag.Title = "Verificationcode";
        ...
        public ActionResult MobileResetPassword()
        {
            ViewBag.Title = "ResetPassword";
        ...
        public ActionResult MobileResetsuccess()
        {
            ViewBag.Title = "Resetsuccess";
                ...
                if (patientdataview.FirstName == null)
                {
                    ...
                    if (overviewreader.HasRows == true)
                    {
                        while (overviewreader.Read())
                        {
                            SickleCelloverviewclass overviewddatagroup = new SickleCelloverviewclass
                            {
                                ...
                                UniqueID = overviewreader["UniqueID"].ToString(),
                                State = overviewreader["State"].ToString(),
                                Email_Address = overviewreader["Email_Address"].ToString(),
                                Race = overviewreader["Race"].ToString(),
                                Eligibility = overviewreader["Eligibility"].ToString(),
                                Ethnicity = overviewreader["Ethnicity"].ToString(),
                                SSN = overviewreader["SSN"].ToString(),
                                PhoneNumber = overviewreader["PhoneNumber"].ToString(),
                                ZipCode = overviewreader["ZipCode"].ToString(),
                                HomePhone = overviewreader["HomePhone"].ToString(),
                                WorkPhone = overviewreader["WorkPhone"].ToString(),
                                SicklecelltypeID = overviewreader["SicklecelltypeID"].ToString(),
                                SickleCellDiagnosis = overviewreader["SickleCellDiagnosis"].ToString(),
                                PMPProviderName = overviewreader["PMPProviderName"].ToString(),
                                CCUCase = overviewreader["CCUCase"].ToString(),
                                Specialist = overviewreader["Specialist"].ToString(),
                                Medication = overviewreader["Medication"].ToString(),
                                Emergency_Contact1 = overviewreader["Emergency_Contact1"].ToString(),
                                Emergency_Contact1_HomePhone = overviewreader["Emergency_Contact1_HomePhone"].ToString(),
                                Emergency_Contact1_CellPhone = overviewreader["Emergency_Contact1_CellPhone"].ToString()
                            };
                    ...
                    if (overviewreader2.HasRows == true)
                    {
                        while (overviewreader2.Read())
                        {
                            ...
                            {
                                ClientID = overviewreader2["ClientID"].ToString(),
                                LastName = overviewreader2["LastName"].ToString(),
                                FirstName = overviewreader2["FirstName"].ToString(),
                                DOB = overviewreader2["DOB"].ToString(),
                                Gender = overviewreader2["Gender"].ToString(),
                                FullStreetAddress = overviewreader2["FullStreetAddress"].ToString(),
                                City = overviewreader2["City"].ToString(),
                                State = overviewreader2["State"].ToString(),
                                Email_Address = overviewreader2["Email_Address"].ToString()
                            };
            ...
            try
            {
                ...
                if (breakdownreader.HasRows == true)
                {
                    while (breakdownreader.Read())
                    {
                        ...
                        {
                            ClientID = breakdownreader["ClientID"].ToString(),
                            LastName = breakdownreader["LastName"].ToString(),
                            FirstName = breakdownreader["FirstName"].ToString(),
                            DOB = breakdownreader["DOB"].ToString(),
                            Gender = breakdownreader["Gender"].ToString(),
                            FullStreetAddress = breakdownreader["FullStreetAddress"].ToString(),
                            City = breakdownreader["City"].ToString(),
                            State = breakdownreader["State"].ToString(),
                            Email_Address = breakdownreader["Email_Address"].ToString()
                        };
        ...
        public ActionResult Select(SickeCellclass selected)
        {
            ...
            List<ISickeCellclass> selecteddata = new List<ISickeCellclass>();
            ISickeCellclass selecteddatagroup = new SickeCellclass();           

            try
            {
               CheckexistingFullName();
               IEnumerable<ISickeCellclass> CheckexistingFullName()
               {
                    ...
                    else
                    {
                        ...
                        string[] seldate = selected.DOB.Split('-');
                        string seldate1 = seldate[0].ToString();
                        string seldate2 = seldate[1].ToString();
                        string seldate3 = seldate[2].ToString();
                        String vdob3 = seldate2 + "/" + seldate3 + "/" + seldate1;
        ...
        public ActionResult Validation(Confirmation confirmvalue)
        {
            ...
            List<IConfirmation> listdata = new List<IConfirmation>();
            IConfirmation listdataResponse = new Confirmation();
            try
            {
        ...
        {
            List<ISickeCellclass> lisRegistered = new List<ISickeCellclass>();
            try
            {
                ...
                {
                    ISickeCellclass datacomments = new SickeCellclass
                    {
                        NotesID = Convert.ToInt16(datareader["NotesID"]),
        ...
        {
            List<ISickeCellclass> listIntegrate = new List<ISickeCellclass>();
            try
            {
                connection.Open();
                SqlCommand searchclientid = new SqlCommand("SickeCell_Stored_Search_idx", connection)
                ...
                while (clientidreader.Read())
                {
                    ISickeCellclass Integrate_Data = new SickeCellclass
                    {
                        ClientID = clientidreader["ClientID"].ToString(),
                        LastName = clientidreader["LastName"].ToString(),
                        FirstName = clientidreader["FirstName"].ToString(),
                        Middle_Initial = clientidreader["Middle_Initial"].ToString(),
                        UniqueID = clientidreader["UniqueID"].ToString(),
                        DOB = clientidreader["DOB"].ToString(),
                        Age = clientidreader["Age"].ToString(),
                        AgeGroup = clientidreader["AgeGroup"].ToString(),
                        Ageat = clientidreader["Ageat"].ToString(),
                        Gender = clientidreader["Gender"].ToString(),
                        Race = clientidreader["Race"].ToString(),
                        Ethnicity = clientidreader["Ethnicity"].ToString(),
                        Eligibility = clientidreader["Eligibility"].ToString(),
                        SSN = clientidreader["SSN"].ToString(),
                        CountyCode = clientidreader["CountyCode"].ToString(),
                        CountyCodeDescription = clientidreader["CountyCodeDescription"].ToString(),
                        PhoneNumber = clientidreader["PhoneNumber"].ToString(),
                        SickleCellDiagnosis = clientidreader["SickleCellDiagnosis"].ToString(),
                        FullStreetAddress = clientidreader["FullStreetAddress"].ToString(),
                        FullStreetAddress2 = clientidreader["FullStreetAddress2"].ToString(),
                        City = clientidreader["City"].ToString(),
                        State = clientidreader["State"].ToString(),
                        ZipCode = clientidreader["ZipCode"].ToString(),
                        PMPProviderName = clientidreader["PMPProviderName"].ToString(),
                        CCUCase = clientidreader["CCUCase"].ToString(),
                        Email_Address = clientidreader["Email_Address"].ToString(),
                        ClientresideinruralID = clientidreader["ClientresideinruralID"].ToString(),
                        Nameofmother = clientidreader["Nameofmother"].ToString(),
                        Address_Of_Mother = clientidreader["Address_Of_Mother"].ToString(),
                        Telephone_Of_Mother = clientidreader["Telephone_Of_Mother"].ToString(),
                        Nameoffather = clientidreader["Nameoffather"].ToString(),
                        Address_Of_Father = clientidreader["Address_Of_Father"].ToString(),
                        Telephone_Of_Father = clientidreader["Telephone_Of_Father"].ToString(),
                        Nameofguardian = clientidreader["Nameofguardian"].ToString(),
                        Address_Of_Guardian = clientidreader["Address_Of_Guardian"].ToString(),
                        Guardian_Telephone = clientidreader["Guardian_Telephone"].ToString(),
                        Emergency_Contact1 = clientidreader["Emergency_Contact1"].ToString(),
                        Emergency_Contact1_HomePhone = clientidreader["Emergency_Contact1_HomePhone"].ToString(),
                        Emergency_Contact1_CellPhone = clientidreader["Emergency_Contact1_CellPhone"].ToString(),
                        Emergency_Contact2 = clientidreader["Emergency_Contact2"].ToString(),
                        Emergency_Contact2_HomePhone = clientidreader["Emergency_Contact2_HomePhone"].ToString(),
                        Emergency_Contact2_CellPhone = clientidreader["Emergency_Contact2_CellPhone"].ToString(),
                        SicklecelltypeID = clientidreader["SicklecelltypeID"].ToString(),
                        HydroxyureaheardID = clientidreader["HydroxyureaheardID"].ToString(),
                        HydroxyureatakenID = clientidreader["HydroxyureatakenID"].ToString(),
                        HydroxyureacurrentlyID = clientidreader["HydroxyureacurrentlyID"].ToString(),
                        HydroxyureapasttakenID = clientidreader["HydroxyureapasttakenID"].ToString(),
                        Hydroxyureadosage = clientidreader["Hydroxyureadosage"].ToString(),
                        Hydroxyureadosageunknown = clientidreader["Hydroxyureadosageunknown"].ToString(),
                        Hydroxyureacapsulescolor = clientidreader["Hydroxyureacapsulescolor"].ToString(),
                        Pharma1heardID = clientidreader["Pharma1heardID"].ToString(),
                        Pharma1takenID = clientidreader["Pharma1takenID"].ToString(),
                        Pharma1currentlyID = clientidreader["Pharma1currentlyID"].ToString(),
                        Pharma1pasttakenID = clientidreader["Pharma1pasttakenID"].ToString(),
                        Pharma1dosage = clientidreader["Pharma1dosage"].ToString(),
                        Pharma1dosageunknown = clientidreader["Pharma1dosageunknown"].ToString(),
                        Pharma1capsulescolor = clientidreader["Pharma1capsulescolor"].ToString(),
                        Pharma2heardID = clientidreader["Pharma2heardID"].ToString(),
                        Pharma2takenID = clientidreader["Pharma2takenID"].ToString(),
                        Pharma2currentlyID = clientidreader["Pharma2currentlyID"].ToString(),
                        Pharma2pasttakenID = clientidreader["Pharma2pasttakenID"].ToString(),
                        Pharma2dosage = clientidreader["Pharma2dosage"].ToString(),
                        Pharma2dosageunknown = clientidreader["Pharma2dosageunknown"].ToString(),
                        Pharma2capsulescolor = clientidreader["Pharma2capsulescolor"].ToString(),
                        Pharma3heardID = clientidreader["Pharma3heardID"].ToString(),
                        Pharma3takenID = clientidreader["Pharma3takenID"].ToString(),
                        Pharma3currentlyID = clientidreader["Pharma3currentlyID"].ToString(),
                        Pharma3pasttakenID = clientidreader["Pharma3pasttakenID"].ToString(),
                        Pharma3dosage = clientidreader["Pharma3dosage"].ToString(),
                        Pharma3dosageunknown = clientidreader["Pharma3dosageunknown"].ToString(),
                        Pharma3capsulescolor = clientidreader["Pharma3capsulescolor"].ToString(),

                        Comments = clientidreader["Comments"].ToString()
                    };
            ...
            {               
                if (historyreader.HasRows == true)
                {
                    while (historyreader.Read())
                    {
                        ...
                        {
                            FirstName = historyreader["FirstName"].ToString(),
                            LastName = historyreader["LastName"].ToString(),
                            Role = historyreader["Role"].ToString(),
                            Email = historyreader["Email"].ToString(),
                            CurrentDatehis = historyreader["CurrentDate"].ToString().Substring(0, 10),
                            //historydatagroup.CurrentDatehis = Convert.ToDateTime(historyreader["CurrentDate"]); 
                            Logged_In = historyreader["Logged_In"].ToString()
                        };
