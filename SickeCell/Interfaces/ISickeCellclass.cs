...
{
    public interface ISickeCellclass
    {
        ...
        string Medication2 { get; set; }
        string Medication3 { get; set; }
        string Medication4 { get; set; }
        ...
        Decimal ZipCode2 { get; set; }
        Decimal CountryCode2 { get; set; }
        Decimal PhoneNumber2 { get; set; }
        string Deceased { get; set; }
        ActionResult Select(ISickeCellclass selected);
    }
}
