...
myapp.controller("viewController", ["$scope", "$http", "$rootScope", "$window", function ($scope, $http, $rootScope, $window) {
    ...
    if (sPage.trim() === "Entry" || sPage.trim() === "entry") {
        ...
        window.onbeforeunload = function (event) {
            if (vskip !== 1 && x > 210 && x < 1200 || x === undefined && y === undefined) {
    ...
    if (sPage.trim() === "login" || sPage.trim() === "Login" || sPage.trim() === "Successful" || sPage.trim() === "Signup" || sPage.trim() === "Login2" || sPage.trim() === "login2" || sPage.trim() === "PleaseConfirm") {
        ...
        if (sPage.trim() === "Uploadcsv" || sPage.trim() === "uploadcsv" || sPage.trim() === "PatientOverview" || sPage.trim() === "patientoverview" || sPage.trim() === "MobilePatientOverview" || sPage.trim() === "mobilepatientoverview" || sPage.trim() === "Entry" || sPage.trim() === "entry" || sPage.trim() === "MobileEntry" || sPage.trim() === "mobileentry" || sPage.trim() === "Casenotes" || sPage.trim() === "casenotes" || sPage.trim() === "MobileCasenotes" || sPage.trim() === "mobilecasenotes" || sPage.trim() === "Index" || sPage.trim() === "index" || sPage.trim() === "MobileIndex" || sPage.trim() === "mobileindex" || sPage.trim() === "Register" || sPage.trim() === "register" || sPage.trim() === "Viewlogs" || sPage.trim() === "viewlogs" || sPage.trim() === "Manageconsole" || sPage.trim() === "manageconsole" || sPage.trim() === "Manageconsoleoption" || sPage.trim() === "manageconsoleoption" || sPage.trim() === "Patientpage" || sPage.trim() === "patientpage") {
