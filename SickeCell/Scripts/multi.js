...
myapp.controller("viewController", ["$scope", "$http", "$rootScope", "$window", function ($scope, $http, $rootScope, $window) {
    ...
    if (sPage.trim() === "Entry" || sPage.trim() === "entry" || sPage.trim() === "MobileEntry" || sPage.trim() === "mobileentry") {
    ...
    if (sPage.trim() ==="") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
    ...
    if (sPage.trim() === "Entry" || sPage.trim() === "entry") {
        ...
        var isMobile2 = /iPhone|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {            
            window.location.href = "/Home/MobileEntry";
        } else {
        ...
        zblog = localStorage.getItem("testlog");
        ////////////////////////////////////////////////////////////////        
        x = 1;
        y = 1;
        window.onmousewheel = savePosition;
        window.onmouseup = savePosition;
        window.onmousemove = savePosition;
        window.onbeforeunload = function (event) {
            alert("two");
            if (vskip !== 1 && x > 210 && x < 1200 || x === undefined && y === undefined || x === 1) {
        ...
        if (globalRoleName === "Case Manager") {
            ...
            $http({ method: "POST", url: "/Home/Update", data: JSON.stringify(datavalue), dataType: 'json', contentType: "application/json" }).success(function (response) {
                ...
                if (updatecounter === 0) {
                    ...
                    document.getElementById("options1").style.marginLeft ="-210px";
                        ...
                        if (response[0]["Password"] !== "") {
                            ...
                            if (counterlog === 0 && document.getElementById('email')['value'] !== null) {
                                $http({ method: "POST", url: "/Home/Saveloggedin", data: JSON.stringify(savelogin), dataType: 'json', contentType: "application/json" }).success(function (dataresponse) {
                                    ...
                                    isMobile2 = /iPhone|iPod|Android/i.test(navigator.userAgent);
                                    if (isMobile2 === true) {
    ...
    if (sPage.trim() === "Manageconsoleoption" || sPage.trim() === "manageconsoleoption") {
        ...
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            window.location.href = "/Home/MobileManageconsoleoption";
        } else {            
            console.log("Manageconsoleoption");
        }
    ...
    if (sPage.trim() === "login" || sPage.trim() === "Login" || sPage.trim() === "Successful" || sPage.trim() === "Signup" || sPage.trim() === "Login2" || sPage.trim() === "login2" || sPage.trim() === "PleaseConfirm") {
        ...
        if (isMobile2 !== true) {
            ...
            isMobile2 = /iPad|iPod/i.test(navigator.userAgent);
            if (isMobile2 === true) {
                document.getElementById("navigation").style.visibility = "hidden";
                document.getElementById("ul").style.visibility = "hidden";
                ...
                //var vnavvar = document.getElementsByClassName("navbar-brand")[0].
                //vnavvar.style.visibility = "hidden";                
        ...
        if (sPage.trim() === "Uploadcsv" || sPage.trim() === "uploadcsv" || sPage.trim() === "MobileUploadcsv" || sPage.trim() === "mobileuploadcsv" || sPage.trim() === "PatientOverview" || sPage.trim() === "patientoverview" || sPage.trim() === "MobilePatientOverview" || sPage.trim() === "mobilepatientoverview" || sPage.trim() === "Entry" || sPage.trim() === "entry" || sPage.trim() === "MobileEntry" || sPage.trim() === "mobileentry" || sPage.trim() === "Casenotes" || sPage.trim() === "casenotes" || sPage.trim() === "MobileCasenotes" || sPage.trim() === "mobilecasenotes" || sPage.trim() === "Index" || sPage.trim() === "index" || sPage.trim() === "MobileIndex" || sPage.trim() === "mobileindex" || sPage.trim() === "Register" || sPage.trim() === "register" || sPage.trim() === "Viewlogs" || sPage.trim() === "viewlogs" || sPage.trim() === "Manageconsole" || sPage.trim() === "manageconsole" || sPage.trim() === "MobileManageconsole" || sPage.trim() === "mobilemanageconsole" || sPage.trim() === "Manageconsoleoption" || sPage.trim() === "manageconsoleoption" || sPage.trim() === "MobileManageconsoleoption" || sPage.trim() === "mobilemanageconsoleoption" || sPage.trim() === "Patientpage" || sPage.trim() === "patientpage") {

            var globalEmail = localStorage.getItem("variableEmail2");
            var globalRoleName = localStorage.getItem("variableRole");
            voptionrole = localStorage.getItem("optionrole");
            ...
            if (globalRoleName === "" && globalEmail === "") {
                ...
                isMobile2 = /iPhone|iPad|Android/i.test(navigator.userAgent);
                ...
                if (isMobile2 === true) {                
                    ...
                    if (globalRole === "Super Admin") {
                        if (isiPad2 === true) {
                            ...
                            document.getElementById("my_account4").style.visibility = "hiiden";
                            document.getElementById("username4").style.visibility = "hidden";

                            document.getElementById("ul3").style.visibility = "visible";

                            //document.getElementById("mobileicon2").style.visibility = "visible";
                        } else {
                            document.getElementById("nav2").style.visibility = "visible";
                            document.getElementById("cnt2").style.visibility = "visible";
                            ...
                            document.getElementById("my_account2").style.visibility = "hiiden";
                            document.getElementById("username2").style.visibility = "hidden";
                        ...
                        if (isiPad2 === true) {
                            ...
                            document.getElementById("ul3").style.visibility = "visible";
                            document.getElementById("ul3").style.marginLeft = "-100px;";
    ...
    if (sPage.trim() === "Manageconsole" || sPage.trim() === "manageconsole") {
        ...
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            window.location.href = "/Home/MobileManageconsole";
        } else {
            console.log("Manageconsole");
        }
            ...
            if (response !== "none") {
                ...
                if (response !== "" && apiloop === "0") {
                    ...
                    for (var i = 0; i < response.length; i++) {
                        ...
                        var vsplit = response[i].CurrentDatehis.split("-");
                        var dataconcat = [vsplit[0], vsplit[1], vsplit[2]].join('-');

                        cell4.style.width = "200px";
                        cell4.style.marginLeft = "25px";
                        //cell4.innerHTML = formatDate(response[i].CurrentDatehis);
                        cell4.innerHTML = dataconcat;
        ...
        function formatDate(date) {
            //var d1 = date;
            //day1 = '' + d1.substring(0, 2);
            //month1 = '' + d1.substring(3, 5);
            //year1 = d1.substring(6, 10);
            //var combine = [day1, month1, year1].join('/');
            //var combine = [year1, month1, day1].join('/');

            //var d = new Date(combine.toString()),
            //var z = Date.parse(date);
            var d = new Date(date),
                month = '' + (d.getMonth() + 1),
                day = '' + d.getDate(),
                year = d.getFullYear();
    ...
    if (sPage.trim() === "Casenotes" || sPage.trim() === "casenotes") {
        ...
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {              
              window.location.href = "/Home/MobileCasenotes";
        } else {
            //alert("");
        }
            ...
            if (document.getElementById('pwd')['value'] === document.getElementById('confirmpass')['value']) {
                ...
                $http({ url: result + '/api/Sign/Sign_Post', method: "POST", data: JSON.stringify(datasigned), dataType: 'json', headers: { 'Content-Type': 'application/json' } }).success(function (response) {
                    ...
                    if (response === '""') {
                        ...
                        isMobile2 = /iPhone|iPod|Android/i.test(navigator.userAgent);
                        if (isMobile2 === true) {
                            window.location.href = "/Home/MobileSuccessful";
                        } else {
    ...
    if (sPage.trim() === "Uploadcsv" || sPage.trim() === "uploadcsv") {
        ...
        isMobile2 = /iPhone|iPod|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
             window.location.href = "/Home/MobileUploadcsv";
        } else {
    ...
    if (sPage.trim() === "Consolesignup" || sPage.trim() === "consolesignup") {
        ...
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            window.location.href = "/Home/MobileConsolesignup";
        } else {
            console.log("Consolesignup");
        }
        ...
        if (isMobile2 === true) {
            ...
            if (vlog === "") {
                if (voptionrole !== "1") {
                    ...
                    voptionrole = "";
                    localStorage.setItem("optionrole", "");

                    localStorage.setItem("variableRole", localStorage.globalRoletype);
                }
                //window.location.href = "/Home/Login";
            }
            localStorage.setItem("variableEmail", "");
            ...
            window.onmousemove = savePosition;
            window.onbeforeunload = function () {
                if (vskip !== 1 && x > 210 && x < 1400 || x === undefined && y === undefined || x === 1) {
                    //localStorage.setItem("variableName", "");
                    //localStorage.setItem("variableEmail", "");
                    //localStorage.setItem("variableEmail2", "");
                    //localStorage.setItem("variableRole", "");
                } else {
                    localStorage.setItem("varrefresh", "refresh");
                    x = 0;
                    y = 0;
                }
            };
    ...
    $(document).keyup(function (escape) {
        if (escape.keyCode === 27) {
            $scope.$apply(function () {
                ...
                //document.getElementById("spanid").style.visibility = "hidden";
                //document.getElementById("checkboxlist2").style.visibility = "hidden";
                document.getElementById("boxwrap").style.visibility = "visible";
            });
        }
    });
    ...
    if (sPage.trim() === "PatientOverview" || sPage.trim() === "patientoverview") {
        ...
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            window.location.href = "/Home/MobilePatientOverview";
        } else {
            vlog = localStorage.getItem("variableRole");
            if (vlog === "") {
                window.location.href = "/Home/Login";
    ...
    //////////////////// Mobile features ///////////////////////////////
    if (sPage.trim() === "MobileLogin" || sPage.trim() === "mobilelogin") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {           
            confirmedmail = localStorage.getItem("variableEmail");
            confirmvalue = {
    ...
    if (sPage.trim() === "MobilePatientOverview" || sPage.trim() === "mobilepatientoverview") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            console.log("MobilePatientOverview");            
                ...
                for (i = 0; i < rows.length; i++) {
                    ...
                    var createClickHandler = function (row) {
                        return function () {
                            ...
                            optn.style.color = "white";
                            optn.style.backgroundColor = "cornflowerblue";
                            optn.style.width = "20px";
                            optn.style.height = "20px";
                            optn.style.fontWeight = "900";
                            
                            optn.onclick = close;

                            //optn.style.marginLeft = "365px";
                            optn.style.marginLeft = "2.50px";
                       
                            optn.innerHTML = "X";
                            optn.onmouseover = onchanging;
                            //optn.style.position = "fixed";                  
                            //optn.style.borderRadius = "2px";
                            ...
                            document.getElementById("boxwrap").style.visibility = "hidden";                            
                            document.getElementById("comments3").style.visibility = "visible";

                            orientation = Math.abs(window.orientation) === 90 ? 'landscape' : 'portrait';
                            if (orientation === 90) {
                                document.getElementById("comments3").style.width = "648px";
                                document.getElementById("comments3").style.maxWidth = "640px";
                            } else {
                                document.getElementById("comments3").style.width = "398px";
                                document.getElementById("comments3").style.maxWidth = "390px";
                            }

                            document.getElementById("comments3").style.position = "relative";                            
                            document.getElementById("comments3").style.marginLeft = "0em";
                            document.getElementById("comments3").style.marginTop = "-16.50em";
                            document.getElementById("comments3").style.fontWeight = 700;
                            document.getElementById("comments3").style.height = "450px";
                            document.getElementById("comments3").style.maxHeight = "450px";
                            document.getElementById("comments3").style.fontFamily = "Courier New, Courier, monospace";
                            document.getElementById("comments3").style.fontSize = "16px";
                            document.getElementById("comments3").style.borderWidth = "1px";
                            document.getElementById("comments3").style.border = "1px solid groove";
                            document.getElementById("comments3").style.resize = "both";
                            document.getElementById("comments3").style.boxSizing = "border - box";
                            document.getElementById("comments3").style.overflowX = "auto";
                            document.getElementById("comments3").style.borderRadius = "12px";
            ...
            touched = localStorage.getItem("touch");
            if (touched === "true") {
                console.log(touched);
                x = 50;
            ...
            window.onmousemove = savePosition;
            window.onbeforeunload = function () {
                if (vskip !== 1 && x > 600 && x < 1200 || x === undefined && y === undefined || x === 1) {
                    localStorage.setItem("variableName", "");
                    localStorage.setItem("variableEmail", "");
                    localStorage.setItem("variableEmail2", "");
                    localStorage.setItem("variableRole", "");
    ...
    if (sPage.trim() === "MobileEntry" || sPage.trim() === "mobileentry") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {            
            document.getElementById("options1").style.marginLeft = "-210px";
            isIpad4 = /iPad/i.test(navigator.userAgent);
            //if (isIpad4 === true) {
            //    orientation = Math.abs(window.orientation) === 90 ? 'landscape' : 'portrait';
            //    if (orientation === 90) {
            //        document.getElementById("dropdown-toggle_id").style.marginTop = "-30px";
            //    } else {
            //        document.getElementById("dropdown-toggle_id").style.marginTop = "-10px";            
            //    }                
            //}
        ...
        $scope.Clientsearch = function () {
            ...
            if (document.getElementById("searchclient")["value"] !== "" || document.getElementById("firstname")["value"] !== "") {
                $http({ method: "POST", url: "/Home/Select", data: JSON.stringify(selected), dataType: 'json', contentType: "application/json" }).success(function (response) {
                    ...
                    document.getElementById("update").style.visibility = "visible";
                    document.getElementById("save").style.visibility = "hidden";       
                    document.getElementById("options1").style.marginLeft = "-300px";                                                     
    ...
    if (sPage.trim() === "MobileUploadcsv" || sPage.trim() === "mobileuploadcsv") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            vlog = localStorage.getItem("variableRole");
            if (vlog === "") {
            ...
            //document.getElementById("fileUpload").style.fontWeight = "400";
            //document.getElementById("fileUpload").style.width = "500px";
            document.getElementById("fileUpload").style.width = "300px";
            document.getElementById("fileUpload").style.height = "20px";            
            document.getElementById("fileUpload").style.marginLeft = "25px";
            document.getElementById("fileUpload").style.transform = "scale(1.20,2)";

            //document.getElementById("fileUpload").style.transform = "scale(0.23,1)";
           ...
           ////////////////////////////////////////////////////////////////        
            ...
            window.location.href = "/Home/Uploadcsv";
        }
    }

    if (sPage.trim() === "MobileManageconsoleoption" || sPage.trim() === "mobilemanageconsoleoption") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            console.log("MobileManageconsoleoption");
        } else {
            window.location.href = "/Home/Manageconsoleoption";
        }
    ...
    if (sPage.trim() === "MobileConsolesignup" || sPage.trim() === "mobileconsolesignup") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            console.log("MobileConsolesignup");
        } else {
            window.location.href = "/Home/Consolesignup";
        }
    }

    if (sPage.trim() === "MobileSignup" || sPage.trim() === "mobilesignup") {
        isMobile2 = /iPhone|iPod|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
    ...
    if (sPage.trim() === "Signup" || sPage.trim() === "signup") {
        isMobile2 = /iPhone|iPod|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            window.location.href = "/Home/MobileSignup";
        } else {
            console.log("Signup");
        }
    }

    if (sPage.trim() === "MobileManageconsole" || sPage.trim() === "mobilemanageconsole") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            vlog = localStorage.getItem("variableRole");
            if (vlog === "") {
                ...
                if (response !== "none") {
                    ...
                    if (response !== "" && apiloop === "0") {
                        ...
                        for (var i = 0; i < response.length; i++) {
                             ...
                             cell2.style.marginLeft = "150px";
                             cell2.innerHTML = response[i].Email;

                             cell3.style.width = "200px";
                             cell3.style.marginLeft = "60px";
                             cell3.innerHTML = response[i].Role;
            ...
            window.location.href = "/Home/Manageconsole";
        }
    }

    if (sPage.trim() === "MobileCasenotes" || sPage.trim() === "mobilecasenotes") {
        isMobile2 = /iPhone|iPod|iPad|Android/i.test(navigator.userAgent);
        if (isMobile2 === true) {
            isIpad4 = /iPad/i.test(navigator.userAgent);
            if (isIpad4 === true) {
                //orientation = Math.abs(window.orientation) === 90 ? 'landscape' : 'portrait';
                //if (orientation === 90) {
                //    document.getElementById("ul3").style.marginTop = "-20px";
                //} else {
                //    document.getElementById("ul3").style.marginTop = "-20px";                                     
                //}
                //var navbar = document.getElementsByClassName("navbar - brand");
                //navbar.marginLeft = "30px";
            }            

        } else {
            window.location.href = "/Home/Casenotes";
        }
        ...
        $scope.Savenotes = function () {
            ...
            var savingnotes = {
                ...
                'LastName': globalLastName,
                'DOB': globalDOB,
                'Comments': currdate2 + " - " + currtime + " --  " + globalusrfname + " " + globalusrlname + " -- " + document.getElementById("notes2")["value"],                
                'UserFirstName': globalusrfname,
                'UserLastName': globalusrlname,
                'TimeStamp': currtime,
                'Datenotescreated': formatDate(currdate)
            ...
            vnotes = document.getElementById("notes2")["value"].trim();
            vnotesclientid = document.getElementById("clientid")["value"];
            if (vnotes !== "") {
                if (vnotesclientid !== "") {
                    $http({ method: "POST", url: "/Home/Savenotes", data: JSON.stringify(savingnotes), dataType: 'json', contentType: "application/json" }).success(function (responsesave) {
                        document.getElementById("notes")["value"] = '';
                    ...
                    swal("Invalid", "Invalid, You have an empty ClientID", {
                        className: "swal-title"
                    });
                }                
            } else {                
    ...
    if (sPage.trim() === "MobileIndex" || sPage.trim() === "mobileindex") {
        ...
        var refreshcontrol;
        refreshcontrol = localStorage.getItem("varrefresh");
        if (refreshcontrol === "refresh") {
            window.location.href = "/Home/MobileIndex";
            localStorage.setItem("varrefresh", "");
